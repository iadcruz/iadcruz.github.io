...
export const skills = getSkills('js', 'css', 'html', 'nodejs', 'python', 'java', 'mongodb', 'expressjs', 'pandas', 'numpy', 'ocaml', 'swing', 'ts', 'tailwind', 'postgresql', 'react', 'nextjs', 'clerk', 'prisma', 'nodejs');